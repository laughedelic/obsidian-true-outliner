...
Related: [structured-backlinks.md](structured-backlinks.md) (the footer's design, and D17,
which already names filtered search as the projection's second consumer),
[surfaces-and-embedding.md](surfaces-and-embedding.md) (what drawing the outline on a
second surface costs), [zoom-hiding-mechanism.md](zoom-hiding-mechanism.md) (the hiding
